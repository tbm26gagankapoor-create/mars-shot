      ...
      <Tabs defaultValue="overview">
        <TabsList>
          ...
          <TabsTrigger value="rounds">
            Follow-on Rounds ({company.followOnRounds.length})
          </TabsTrigger>
          <TabsTrigger value="notes">
            Board Notes ({company.boardNotes.length})
          </TabsTrigger>
        ...
        <TabsContent value="overview" className="mt-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <div className="grid grid-cols-2 gap-2 text-sm">
                  ...
                  <div>
                    <span className="text-muted-foreground">Date Invested</span>
                    <p>
                      {company.dateInvested
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-base">Primary Founder</CardTitle>
              </CardHeader>
              <CardContent className="space-y-3">
                {company.founderName ? (
                ...
                <div className="space-y-3">
                  {company.followOnRounds.map((round) => (
                    ...
                    >
                      ...
                      <Badge
                        variant={
                          round.marsShotParticipated ? "default" : "secondary"
                        }
